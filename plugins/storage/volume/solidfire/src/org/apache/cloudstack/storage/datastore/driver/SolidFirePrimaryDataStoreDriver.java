...
public class SolidFirePrimaryDataStoreDriver implements PrimaryDataStoreDriver {
    ...
    @Override
    public synchronized boolean connectVolumeToHost(DataObject dataObject, Host host, DataStore dataStore)
    {
    ...
    @Override
    public synchronized void disconnectVolumeFromHost(DataObject dataObject, Host host, DataStore dataStore)
    {
    ...
    private long getUsedIops(StoragePool storagePool) {
        long usedIops = 0;
