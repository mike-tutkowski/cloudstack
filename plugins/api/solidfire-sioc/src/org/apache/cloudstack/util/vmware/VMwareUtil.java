...
public class VMwareUtil {
    ...
    public static class VMwareConnection {
        ...
        public VMwareConnection(VimPortType vimPortType, ServiceContent serviceContent) {
    ...
    public static ManagedObjectReference getVmByName(VMwareConnection connection, String vmName) throws Exception {
        ...
        List<PropertyFilterSpec> lstPfs = new ArrayList<PropertyFilterSpec>(1);
        ...
        throw new RuntimeException("The following VM could not be located: " + vmName + ".");
    }
    ...
    private static Object[] waitForValues(VMwareConnection connection, ManagedObjectReference morObj, String[] filterProps,
        ...
        List<PropertyFilterUpdate> lstPropertyFilterUpdates = null;
        List<ObjectUpdate> lstObjectUpdates = null;
        List<PropertyChange> lstPropertyChanges = null;
    ...
    private static List<ObjectContent> retrievePropertiesAllObjects(List<PropertyFilterSpec> lstPfs,
        ...
        List<ObjectContent> lstObjectContent = new ArrayList<ObjectContent>();
