...
public class SolidFireSiocManagerImpl implements SolidFireSiocManager {
    ...
    private static final int DEFAULT_SHARES_PER_VIRTUAL_DISK = 1000;
    ...
    private static final long DEFAULT_LIMIT_IOPS_PER_VIRTUAL_DISK = HIGHEST_LIMIT_IOPS_PER_VIRTUAL_DISK;
    ...
    private int getNewShares(VolumeVO volumeVO, Optional<Integer> sharesPerGB) {
        ...
        return DEFAULT_SHARES_PER_VIRTUAL_DISK;
    }
